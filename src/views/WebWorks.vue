  ...
  <div class="flex-col">
    ...
    <div class="flex flex-wrap items-start xl:mt-32">
      ...
      <div class="w-full md:w-1/2 xl:w-1/3 2xl:w-1/4">
        <WebCard v-for="item in projectsArr1" :key="item.name">
          <!-- 小縮圖 -->
      ...
      <!-- Waterfall 2 -->
      <div class="w-full md:w-1/2 xl:w-1/3 2xl:w-1/4">
        <WebCard v-for="item in projectsArr2" :key="item.name">
          <!-- 小縮圖 -->
          <template v-slot:cover>
            <img :src="item.imgCover" :alt="item.name" />
          </template>
      ...
      <!-- Waterfall 3 -->
      <div class="w-full md:w-1/2 xl:w-1/3 2xl:w-1/4">
        <WebCard v-for="item in projectsArr3" :key="item.name">
          <template v-slot:cover>
            <img :src="item.imgCover" :alt="item.name" />
          </template>
          <template v-slot:contentTittle>
      ...
      <!-- Waterfall 4 -->
      <div class="w-full md:w-1/2 xl:w-1/3 2xl:w-1/4">
        <WebCard v-for="item in projectsArr4" :key="item.name">
          <!-- 小縮圖 -->
          <template v-slot:cover>
            <img :src="item.imgCover" :alt="item.name" />
          </template>
